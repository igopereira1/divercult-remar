...
<div class="cluster-header">
    <p class="text-teal text-darken-3 left-align margin-bottom" style="font-size: 28px;">
        Divercult2D - Customização da fase 2
...
<table class="highlight" id="table" style="margin-top: -30px;">
    ...
    <tr>
        ...
        <th>Formacao <div class="row" style="margin-bottom: -10px;"><button class="btn-floating"
                                                                            style="visibility: hidden"></button></div>
        
        <th>Cursos <div class="row" style="margin-bottom: -10px;"><button class="btn-floating"
                                                                        style="visibility: hidden"></button></div></th>

        <th>Experiência <div class="row" style="margin-bottom: -10px;"><button class="btn-floating"
                                                                        style="visibility: hidden"></button></div></th>

        <th>Pontuacao Extra <div class="row" style="margin-bottom: -10px;"><button class="btn-floating"
                                                                        style="visibility: hidden"></button></div></th>
    ...
    <g:each in="${listaPares}" status="i" var="par">
        <tr id="tr${par.id}" class="selectable_tr ${(i % 2) == 0 ? 'even' : 'odd'} " style="cursor: pointer;"
            ...
            data-checked="false">
                ...
                <td>${fieldValue(bean: par, field: "school")}</td>
                <td>${fieldValue(bean: par, field: "exp")}</td>
                <td>${fieldValue(bean: par, field: "bonus")}</td>

                <td name="theme" id="theme"></td>
...
<div class="row">
    <div class="col s2">
         <th>Tempo de jogo</th>
         <g:textField id="time" name="time" class="remar-input" maxlength="50" required=""/>
        <button class="btn waves-effect waves-light my-orange" type="submit" name="save" id="save">Enviar
        </button>
    </div>

    <div class="col s1 offset-s6">
        <a href= "/divercult/fase2/create" name="create"
           -           class="btn-floating btn-large waves-effect waves-light modal-trigger my-orange tooltipped" data-tooltip="Criar atributos"><i
                -                class="material-icons">add</i></a>
    </div>

    <div class="col s1 m1 l1">
              <a onclick="_delete()" class=" btn-floating btn-large waves-effect waves-light my-orange tooltipped" data-tooltip="Excluir atributos" ><i class="material-icons">delete</i></a>
    </div>
</div>

<g:javascript src="fase2.js"/>
