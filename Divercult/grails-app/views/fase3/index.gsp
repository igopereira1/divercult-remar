...
<div class="cluster-header">
    <p class="text-teal text-darken-3 left-align margin-bottom" style="font-size: 28px;">
        Divercult2D - Customização da fase 3
...
<table class="highlight" id="table" style="margin-top: -30px;">
    ...
    <tr>
        ...
        <th>Casa Especial<div class="row" style="margin-bottom: -10px;"><button class="btn-floating"
                                                                            style="visibility: hidden"></button></div>
...
<div class="row">
    ...
    <div class="col s1 offset-s6">
        <a href= "/divercult/fase3/create" name="create"
           -           class="btn-floating btn-large waves-effect waves-light modal-trigger my-orange tooltipped" data-tooltip="Criar texto da casa especial"><i
                -                class="material-icons">add</i></a>
    </div>

    <div class="col s1 m1 l1">
              <a onclick="_delete()" class=" btn-floating btn-large waves-effect waves-light my-orange tooltipped" data-tooltip="Excluir texto da casa especial" ><i class="material-icons">delete</i></a>
    </div>
</div>

<g:javascript src="fase3.js"/>
